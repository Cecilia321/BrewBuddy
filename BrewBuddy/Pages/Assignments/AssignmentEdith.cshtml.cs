...
namespace BrewBuddy.Pages.Assignments
    {
        public class AssignmentsEdithModel : PageModel
        {
            ...
            public AssignmentsEdithModel(IRepository<Assignment> repository)
            {
            ...
            {
            IncompleteAssignments = GetIncompleteAssignments(allAssignments); //hvis listen skal kunne være null
